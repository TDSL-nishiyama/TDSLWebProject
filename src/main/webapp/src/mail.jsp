...
<body>
  ...
  <form action="<%=request.getContextPath()%>/MailAddAction" method="post">
    <p><input type="submit" value="メールアドレスの新規追加"></p>
    <span class="req">※</span>追加する社員ID:
    <input type="text" name="selId" value="<%=txtUserId%>"><br>
    <span class="req">※</span>追加するメールアドレス:
    <input type="text" name="mailAddress" value="<%=txtMailAddress%>"><br>
  </form>
  </p>
